...
// help link (helpLink), the footer (siteFooter — the layout renders it under every
// page), plus the header's own gear and logo (root.tsx's direct links).
const global = nodesFor(
    new Set([
        ...
        ...crawl(resolve(APP, "components/ui/siteFooter.tsx"), new Set()),
