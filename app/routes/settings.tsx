...
import { SettingsIndex, type SettingsIndexGroup } from "../components/features/settingsIndex";
...
export default function Settings() {
    ...
    // The index lists what the page shows: a panel hidden for want of a browser API is
    // not offered as somewhere to go.
    const groups: SettingsIndexGroup[] = [
        {
            label: m.settings_group_instrument(),
            items: [
                ...(midiSupport === "unsupported"
                    ? []
                    : [{ anchor: "midi", title: m.settings_connect_midi() }]),
                ...(micStatus === "unsupported" ? [] : [{ anchor: "mic", title: m.mic_heading() }]),
                { anchor: "keys", title: m.settings_keyboard() },
                { anchor: "sound", title: m.settings_sound() },
            ],
        },
        {
            label: m.settings_group_playing(),
            items: [
                { anchor: "reading", title: m.settings_reading_title() },
                { anchor: "hand", title: m.settings_fingering() },
                { anchor: "metronome", title: m.settings_metronome() },
            ],
        },
        {
            label: m.settings_group_learning(),
            items: [
                { anchor: "mastery", title: m.settings_mastery() },
                { anchor: "grades", title: m.settings_grades() },
            ],
        },
        {
    ...
    return (
        // Two columns, like the theory course and the glossary: an index down the side
        // needs the room, and this page has grown to more sections than a scroll can hold
        // in the head.
            ...
            surfaces are one set of prefs reached from two places. */}
                    ...
                    >
                        ...
                        <ChoiceField
                            ...
                            options={GROOVES.map((groove) => ({
                                id: groove,
                                label: grooveLabel(groove),
                            }))}
                        />
                        <SwitchField
