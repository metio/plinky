...
import { defaultPrefsFor, type NoteLabels } from "../../core/prefs";
...
// the page language's default; the real value lands on the client re-render like the
...
export function useNoteLabels(): NoteLabels {
    ...
    return useSyncExternalStore(
        ...
        () => defaultPrefsFor(getLocale()).noteLabels,
    );
}
