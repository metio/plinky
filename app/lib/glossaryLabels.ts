...
export const SYMBOL_NAMES: Record<string, () => string> = {
    ...
    fermata: m.glossary_fermata_name,
    beam: m.glossary_beam_name,
    tenuto: m.glossary_tenuto_name,
    hairpin: m.glossary_hairpin_name,
    ledger: m.glossary_ledger_name,
    repeat: m.glossary_repeat_name,
...
export const SYMBOL_GLOSSES: Record<string, () => string> = {
    ...
    fermata: m.glossary_fermata_gloss,
    beam: m.glossary_beam_gloss,
    tenuto: m.glossary_tenuto_gloss,
    hairpin: m.glossary_hairpin_gloss,
    ledger: m.glossary_ledger_gloss,
    repeat: m.glossary_repeat_gloss,
