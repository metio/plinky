...
import type { NoteLabels, NoteLetters } from "./noteNaming";
...
const NOTE_LABELS: NoteLabels[] = ["auto", ...NOTE_LABEL_CYCLE];
...
function defaults(): Prefs {
    return {
        ...
        keepOffline: false,
        noteHints: "always",
        // Every key named, in the way the page's language names a note: do re mi in
