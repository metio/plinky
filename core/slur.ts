...
// Whether a note written at `whole` is joined to the note after it.
//
...
// the join into whatever follows the slur.
export function slurredOnwardAt(spans: readonly SlurSpan[], whole: number): boolean {
