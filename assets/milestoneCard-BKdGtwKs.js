import"./runtime-D8obLm44.js";var e=e=>`Karakter ${e?.level}`,t=((t,n={})=>e(t)),n=e=>`Ferdighet ${e?.rating}`,r=((e,t={})=>n(e)),i=e=>`Jeg nådde karakter ${e?.level} på Plinky!`,a=((e,t={})=>i(e));function o(e){return e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`)}function s({title:e,detail:t}){let n=1080,r=1350,i=t?`<text x="${n/2}" y="800" fill="#a5b4fc" font-family="system-ui,sans-serif" font-size="56" text-anchor="middle">${o(t)}</text>`:``;return`<svg xmlns="http://www.w3.org/2000/svg" width="${n}" height="${r}" viewBox="0 0 ${n} ${r}">\
