...
// Mirrors app/routes/theory.stories.tsx. Owned rather than generated because the story
// imports the page as a DEFAULT export, and the converter matches a module to the bundle
// by file name: "theory" is not the exported name "Theory", so the redirect hands the
...
import { ServicesProvider, Theory } from "plinky";
